...
public interface BidLocalHome extends EJBLocalHome {
   ...
   */
  public BidLocal create(UserLocal bidUser, ItemLocal bidItem, float userBid, float userMaxBid, int quantity) throws CreateException;
   ...
   */
  public BidLocal findByPrimaryKey(Integer id) throws FinderException;
