...
public class ServletPrinter
{
  ...
  void printCategory(String categoryName, int categoryId)
  {
    try
    {
      out.println("<a href=\"edu.rice.rubis.servlets.SearchItemsByCategory?category="+categoryId+
                  "&categoryName="+URLEncoder.encode(categoryName)+"\">"+categoryName+"</a><br>");
    }
    catch (Exception e)
    {
  ...
  void printCategoryByRegion(String categoryName, int categoryId, int regionId)
  {
    try
    {
      out.println("<a href=\"edu.rice.rubis.servlets.SearchItemsByRegion?category="+categoryId+
                  "&categoryName="+URLEncoder.encode(categoryName)+"&region="+regionId+"\">"+categoryName+"</a><br>");
    }
    catch (Exception e)
    {
      out.println("Unable to print Category (exception: "+e+")<br>");
  ...
  void printCategoryToSellItem(String categoryName, int categoryId, int userId)
  {
    try
    {
      out.println("<a href=\"edu.rice.rubis.servlets.SellItemForm?category="+categoryId+"&user="+userId+"\">"+categoryName+"</a><br>");
    }
    catch (Exception e)
    {
      out.println("Unable to print Category (exception: "+e+")<br>");
  ...
  void printRegion(String regionName)
  {
    try
    {
      out.println("<a href=\"edu.rice.rubis.servlets.BrowseCategories?region="+URLEncoder.encode(regionName)+"\">"+regionName+"</a><br>");
    }
    catch (Exception e)
    {
  ...
  void printItem(String itemName, int itemId, float maxBid, int nbOfBids, String endDate)
  {
    try
    {
      out.println("<TR><TD><a href=\"edu.rice.rubis.servlets.ViewItem?itemId="+itemId+"\">"+itemName+
                  "<TD>"+maxBid+
                  "<TD>"+nbOfBids+
                  "<TD>"+endDate+
                  "<TD><a href=\"edu.rice.rubis.servlets.PutBidAuth?itemId="+itemId+"\"><IMG SRC=\"/Servlet_HTML/bid_now.jpg\" height=22 width=90></a>");
    }
    catch (Exception e)
    {
   ...
   */
  void printItemDescription(int itemId, String itemName, String description, float initialPrice, float reservePrice, float buyNow, int quantity, float maxBid, int nbOfBids, String sellerName, int sellerId, String startDate, String endDate, int userId, Connection conn)
  {
    ...
    try
    {
      ...
      out.println("<TR><TD>Quantity<TD><b><BIG>"+quantity+"</BIG></b>\n"+
                  "<TR><TD>First bid<TD><b><BIG>"+firstBid+"</BIG></b>\n"+
                  "<TR><TD># of bids<TD><b><BIG>"+nbOfBids+"</BIG></b> (<a href=\"/servlet/edu.rice.rubis.servlets.ViewBidHistory?itemId="+itemId+"\">bid history</a>)\n"+
                  "<TR><TD>Seller<TD><a href=\"/servlet/edu.rice.rubis.servlets.ViewUserInfo?userId="+sellerId+"\">"+sellerName+"</a> (<a href=\"/servlet/edu.rice.rubis.servlets.PutCommentAuth?to="+sellerId+"&itemId="+itemId+"\">Leave a comment on this user</a>)\n"+
                  "<TR><TD>Started<TD>"+startDate+"\n"+
                  "<TR><TD>Ends<TD>"+endDate+"\n"+
                  "</TABLE>");
      // Can the user buy this item now ?
      if (buyNow > 0)
        out.println("<p><a href=\"/servlet/edu.rice.rubis.servlets.BuyNowAuth?itemId="+itemId+"\">"+
      ...
      if (userId>0)
      {
        ...
        printHTML("<form action=\"/servlet/edu.rice.rubis.servlets.StoreBid\" method=POST>\n"+
    ...
    {
      out.println("Unable to print Item description (exception: "+e+")<br>\n");
    }
  }
  ...
  void printItemUserHasBidOn(int itemId, String itemName, float initialPrice, int quantity, String startDate, String endDate, int sellerId, String sellerName, float currentPrice, float maxBid, String username, String password)
  {
    try
    {
      out.println("<TR><TD><a href=\"/servlet/edu.rice.rubis.servlets.ViewItem?itemId="+itemId+"\">"+itemName+
                  "<TD>"+initialPrice+"<TD>"+currentPrice+"<TD>"+maxBid+"<TD>"+quantity+
                  "<TD>"+startDate+"<TD>"+endDate+
                  "<TD><a href=\"/servlet/edu.rice.rubis.servlets.ViewUserInfo?userId="+sellerId+"\">"+sellerName+
                  "<TD><a href=\"/servlet/edu.rice.rubis.servlets.PutBid?itemId="+itemId+"&nickname="+username+"&password="+password+"\"><IMG SRC=\"/Servlet_HTML/bid_now.jpg\" height=22 width=90></a>\n");
    }
    catch (Exception e)
    {
      out.println("Unable to print Item (exception: "+e+")<br>\n");
  ...
  void printUserWonItem(int itemId, String itemName, float currentPrice, int sellerId, String sellerName)
  {
    try
    {
      out.println("<TR><TD><a href=\"/servlet/edu.rice.rubis.servlets.ViewItem?itemId="+itemId+"\">"+itemName+"</a>\n"+
                  "<TD>"+currentPrice+"\n"+
                  "<TD><a href=\"/servlet/edu.rice.rubis.servlets.ViewUserInfo?userId="+sellerId+"\">"+sellerName+"</a>\n");
    }
    catch (Exception e)
    {
      out.println("Unable to print Item (exception: "+e+")<br>\n");
  ...
  void printUserBoughtItem(int itemId, String itemName, float buyNow, int quantity, int sellerId, String sellerName)
  {
    try
    {
      out.println("<TR><TD><a href=\"/servlet/edu.rice.rubis.servlets.ViewItem?itemId="+itemId+"\">"+itemName+"</a>\n"+
  ...
  void printSell(int itemId, String itemName, float initialPrice, float reservePrice, int quantity, float buyNow, String startDate, String endDate, float currentPrice)
  {
    try
    {
      out.println("<TR><TD><a href=\"/servlet/edu.rice.rubis.servlets.ViewItem?itemId="+itemId+"\">"+itemName+
                  "<TD>"+initialPrice+"<TD>"+currentPrice+"<TD>"+quantity+
		  "<TD>"+reservePrice+"<TD>"+buyNow+
                  "<TD>"+startDate+"<TD>"+endDate+"\n");
    }
    catch (Exception e)
    {
   ...
   */
  void printItemDescriptionToBuyNow(int itemId, String itemName, String description, 
				    float buyNow, int quantity, int sellerId, 
				    String sellerName, String startDate, String endDate, 
				    int userId)
  {
    try
    {
      ...
      printHTML("<form action=\"/servlet/edu.rice.rubis.servlets.StoreBuyNow\" method=POST>\n"+
                "<input type=hidden name=userId value="+userId+">\n"+
                "<input type=hidden name=itemId value="+itemId+">\n"+
                "<input type=hidden name=maxQty value="+quantity+">\n");
      if (quantity > 1)
  ...
  void printBidHistory(int userId, String bidderName, float bid, String date)
  {
    try
    {
      out.println("<TR><TD><a href=\"edu.rice.rubis.servlets.ViewUserInfo?userId="+userId+
  ...
  void printComment(String userName, int userId, String date, String comment)
  {
    try
    {
      out.println("<DT><b><BIG><a href=\"edu.rice.rubis.servlets.ViewUserInfo?userId="+userId+"\">"+userName+"</a></BIG></b>"+
