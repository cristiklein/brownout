...
CLASSPATH=${CLASSPATH}:/users/margueri/RUBiS/EJB_EntityBean_id/rubis.jar:/users/margueri/RUBiS/EJB_EntityBean_id/rubis_ejb_servlets.jar:${JBOSS_DIST}/client/jnet.jar:${JBOSS_DIST}/client/jboss-j2ee.jar:${JBOSS_DIST}/client/jboss-client.jar:${JBOSS_DIST}/client/jbosssx-client.jar:${JBOSS_DIST}/client/jnp-client.jar:${JBOSS_DIST}/client/jboss-common-client.jar:${JBOSS_DIST}/client/log4j.jar:${JBOSS_DIST}/client/jbossmq-client.jar:${JBOSS_DIST}/client/concurrent.jar
