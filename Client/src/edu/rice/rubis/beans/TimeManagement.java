...
public class TimeManagement extends GregorianCalendar
{
   ...
   */
  public static long diffTimeInMs(GregorianCalendar startDate,
      GregorianCalendar endDate)
  {
    ...
    return millis + (second * 1000) + (minute * 60000) + (hour * 3600000)
        + (day * 24 * 3600000) + (month * 30 * 24 * 3600000); // We approximate
                                                              // 30 days per
                                                              // month
  }
